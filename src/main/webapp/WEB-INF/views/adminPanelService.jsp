                        ...
                        <div class="modal-dialog">
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="addService.html" class="col-11 mx-auto " >
                ...
                <div class="top-head-table border"> <h2>Services Available</h2> </div>
                 <table class="table w-75  " id="Service">
                    ...
                    <tbody>
                      <tr onclick="getRow()">
                        <td >  Plumber</td>
                        <td>Repair and fitting</td>
                        <td>90</td>
                        <td>10:00 am-1:00pm</td>
                        <td><button class="update-service-btn btn-primary"data-toggle="modal" data-target="#updateService">Update</button></td>   
                      </tr>
                      <tr>
                        <td >  Electrician</td>
                        <td>New Connection</td>
                        <td>120</td>
                        <td>11:00 am-2:00pm</td>
                        <td><button class="update-service-btn btn-primary"data-toggle="modal" data-target="#updateService">Update </button></td>
                      </tr>
                      <tr>
                        <td > Mechanic</td>
