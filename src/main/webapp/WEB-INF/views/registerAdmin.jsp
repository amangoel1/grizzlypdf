...
<body class="admin-body">
    <nav class="navbar navbar-custom navbar-expand-lg navbar-dark sticky-top"  >
        <div class="logo">
            <img  src="resources/images/admin-logo.png" height="60px" width="60px"/>
        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7 register-right">
                            ...
                            <div class="register-form">
                              ...
                              <div class="form-group">
                                  <input type="text" name="pswd" id="pswd" class="form-control" placeholder="Password"/>
                              ...
                              <input type="submit" name="submit" value="Register" class="btn btn-admin">
                          </div>
                        </div>
                    </div>
                </div>
