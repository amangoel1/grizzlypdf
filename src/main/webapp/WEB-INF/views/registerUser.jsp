                        ...
                        <div class="col-md-7 register-right">
                            ...
                            <div class="register-form">
                                <div class="form-group">
                                    <input required type="text" name="firstName" id="firstName" class="form-control" placeholder="First name"/>
                                    <span id="fname" class="text-danger font-weight-bold"></span>
                                  </div>
                                <div class="form-group">
                                    <input required type="text" name="lastName" id="lastName" class="form-control" placeholder="Last name"/>
                                ...
                                <div class="form-group">
                                    <input required type="text" name="contactNumber" id="contactNumber" class="form-control" placeholder="Contact"/>
                                    <span id="contactNo" class="text-danger font-weight-bold"></span>
                                  </div>
                                <div class="form-group">
                                    <input required type="text" name="pwd" id="pwd" class="form-control" placeholder="Password"/>
