                        ...
                        <div class="col-md-7 register-right">
                            ...
                            <div class="register-form">
                              <div class="form-group">
                                <input required type="text" name="firstName" id="fname" class="form-control" placeholder="First name"/>
                                <span id="firstname" class="text-danger font-weight-bold"></span>
                              </div>
                            <div class="form-group">
                                <input required type="text" name="lastName" id="lname" class="form-control" placeholder="Last name"/>
                            ...
                            <div class="form-group">
                                ...
                                <span id="emailId" class="text-danger font-weight-bold">${error }</span>
                            </div>
                            <div class="form-group">
                                <input required type="text" name="contactNumber" id="contact" class="form-control" placeholder="Contact"/>
                                <span id="contactNo" class="text-danger font-weight-bold"></span>
                              </div>
                            <div class="form-group">
                                <input required type="text" name="pwd" id="pswd" class="form-control" placeholder="Password"/>
                                <span id="password" class="text-danger font-weight-bold"></span>
                           </div>
                            <div class="form-group">
                                <input required type="text" name="conpswd"  id="conpswd" class="form-control" placeholder="Re-Enter Password"/>
                                <span id="confirmpass" class="text-danger font-weight-bold"></span>
                            </div>
                               <div class="form-group">
                                <input required type="text" name="locality"  class="form-control" placeholder="Locality"/>
