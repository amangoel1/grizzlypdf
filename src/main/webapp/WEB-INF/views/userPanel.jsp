...
<head>
    ...
    <script src="resources/css/adminPanel.js"></script>
               ...
               <div class="content" >
                ...
                <table  border="2" class="  w-75 " style="margin-left: 15%;">
                    ...
                    <tr style="background-color: white">
                        <td>Electrician</td>
                        <td><button type="button" class="w-100" style="background-color: red" data-toggle="modal" data-target="#Electrician">
                                Click me
                              </button>
                            </td>
                    </tr>
                    ...
                    <tr style="background-color: white">
                            <td>Plumber</td>
                            <td><button type="button" class="w-100" style="background-color: red" data-toggle="modal" data-target="#Plumber">
                                    Click me
                                  </button>
                                </td>
                        </tr>
                        ...
                        <tr style="background-color: white">
                                <td>Mechanic</td>
                                <td><button type="button" class="w-100" style="background-color: red" data-toggle="modal" data-target="#Mechanic">
                                        Click me
                                      </button>
                                    </td>
                            </tr>
