                    ...
                    <div class=" container  details border ">
                        ...
                        <div class"container " >
                            <form action="submitUserDetails.html" method="post" >
                                <div class="row m-3 ">
                                  <div class="col">
                                    <input type="text" name="firstName" class="form-control border-bottom" placeholder="${user.firstName}">
                                  </div>
                                  <div class="col">
                                    <input type="text" name="lastName" class="form-control border-bottom" placeholder="${user.lastName }">
                                  </div>
                                </div>
                                <div class="row mx-3">
                                    <div class="col">
                                      <input type="text" name="contactNumber" class="form-control border-bottom" placeholder="${user.contactNumber }">
                                    </div>
                                    <div class="col">
                                      <input type="text" name="email" class="form-control border-bottom" placeholder="${user.email}]">
                                    </div>
                                </div >
                                <div class="row m-3">
                                    <div class="col">
